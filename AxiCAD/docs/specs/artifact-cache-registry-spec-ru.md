...
│(.axicad/cache/ - Compiled & Captures)│  ├─────────────────────────────────────┤
│ Portable relative references         │  │ Session-only ephemeral previews/logs│
└──────────────────────────────────────┘  └─────────────────────────────────────┘
```
...
- **Относительные пути кэша проекта**: Файлы кэша проекта хранятся в поддиректории проекта (например, `.axicad/cache/`) и адресуются строго относительно корня проекта (`relativeCachePath`).
