...
> - **Tract geometry binding**: Внешняя геометрия тракта привязывается строго к `connection id/ref`, сохраняя целостность при любых переименованиях шардов и департаментов.
