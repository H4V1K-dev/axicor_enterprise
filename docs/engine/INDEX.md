...
| `baker` | [baker_spec.md](spec_L4/baker_spec.md) | **Approved v2.1 / Implemented (Stage A)** | Оркестратор компиляции AOT, координация фаз сборки, генерация бинарных блобов по `layout`. |
