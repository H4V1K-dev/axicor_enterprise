...
export function initToolbar() {
  ...
  // 3b. Snap Settings Panel
  const snapPanel = document.createElement('div');
  snapPanel.id = 'snap-settings-panel';
  snapPanel.className = 'ax-panel bottom-floating-panel';
  snapPanel.style.display = 'flex';
  snapPanel.style.alignItems = 'center';
  snapPanel.style.gap = '8px';
